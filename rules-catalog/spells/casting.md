...
Each [spell description](https://www.dndbeyond.com/sources/dnd/br-2024/spell-descriptions) has a series of entries that provide the details needed to cast the spell. The following sections explain each of those entries, which follow a spell’s name.
...
Finishing a [Long Rest](../rules/damage-healing-rests.md#LongRest) restores any expended spell slots.
...
Most spells require the [Magic](../rules/actions.md#MagicAction) action to cast, but some spells require a Bonus Action, a Reaction, or 1 minute or more. A spell’s Casting Time entry specifies which of those is required.

### One Spell with a Spell Slot per Turn

On a turn, you can expend only one spell slot to cast a spell. This rule means you can’t, for example, cast a spell with a spell slot using the [Magic](../rules/actions.md#MagicAction) action and another one using a Bonus Action on the same turn.
...
Certain spells—including a spell cast as a [Ritual](../rules/magic-and-spells.md#Ritual) —require more time to cast: minutes or even hours. While you cast a spell with a casting time of 1 minute or more, you must take the [Magic](../rules/actions.md#MagicAction) action on each of your turns, and you must maintain [Concentration](../rules/magic-and-spells.md#Concentration) (see the [Rules Glossary](../rules/magic-and-spells.md#Concentration)) while you do so. If your Concentration is broken, the spell fails, but you don’t expend a spell slot. To cast the spell again, you must start over.
...
If a spell doesn’t consume its materials and doesn’t specify a cost for them, a spellcaster can use a [Component Pouch](https://www.dndbeyond.com/equipment/538-component-pouch) (see “ [Equipment](https://www.dndbeyond.com/sources/dnd/br-2024/equipment#ComponentPouch25GP) ”) instead of providing the materials specified in the spell, or the spellcaster can substitute a Spellcasting Focus if the caster has a feature that allows that substitution. To use a Component Pouch, you must have a hand free to reach into it, and to use a Spellcasting Focus, you must hold it unless its description says otherwise (see “ [Equipment](https://www.dndbeyond.com/sources/dnd/br-2024/equipment/) ” for descriptions).
...
***A Clear Path to the Target.*** To target something with a spell, a caster must have a clear path to it, so it can’t be behind [Total Cover](../rules/combat.md#Cover).

***Targeting Yourself.*** If a spell targets a creature of your choice, you can choose yourself unless the creature must be [Hostile](../rules/attitudes.md#HostileAttitude) or specifically a creature other than you.

***Areas of Effect.*** Some spells, such as [Thunderwave](https://www.dndbeyond.com/spells/2619184-thunderwave), cover an area called an [area of effect](../rules/areas-of-effect.md#AreaofEffect), which is defined in the [Rules Glossary](../rules/areas-of-effect.md#AreaofEffect). The area determines what the spell targets. The description of a spell specifies whether it has an area of effect, which is typically one of these shapes: [Cone](../rules/areas-of-effect.md#ConeAreaofEffect), [Cube](../rules/areas-of-effect.md#CubeAreaofEffect), [Cylinder](../rules/areas-of-effect.md#CylinderAreaofEffect), [Emanation](../rules/areas-of-effect.md#EmanationAreaofEffect), [Line](../rules/areas-of-effect.md#LineAreaofEffect), or [Sphere](../rules/areas-of-effect.md#SphereAreaofEffect).
