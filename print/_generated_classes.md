...
**Default subclass (level 3):** Path of the Berserker
...
**Level 1 progression (from class table):**
| 1 | +2 | Rage, Unarmored Defense, Weapon Mastery | 2 | +2 | 2 |

### Bard

**Default subclass (level 3):** College of Lore
...
**Default subclass (level 3):** Life Domain
...
**Default subclass (level 3):** Circle of the Land
...
**Default subclass (level 3):** Champion
...
**Default subclass (level 3):** Warrior of the Open Hand
...
**Default subclass (level 3):** Oath of Devotion
...
**Default subclass (level 3):** Hunter
...
**Default subclass (level 3):** Thief
...
**Default subclass (level 3):** Draconic Sorcery
...
**Default subclass (level 3):** Fiend Patron
...
**Default subclass (level 3):** Evoker
