# DM Toolbox: Curses and Magical Contagions

Source: [D&D Beyond 2024 DM’s Toolbox](https://www.dndbeyond.com/sources/dnd/br-2024/dms-toolbox)

Curses, demonic possession, and magical contagion examples.

<a id="CursesandMagicalContagions"></a>
...
***Spreading the Contagion.*** Any Humanoid (other than a gnome) that starts its turn within a 10-foot [Emanation](../rules/areas-of-effect.md#EmanationAreaofEffect) originating from a creature infected with Cackle Fever must succeed on a DC 10 Constitution saving throw or also become infected with the contagion. On a successful save, the Humanoid can’t catch the contagion from that particular infected creature for the next 24 hours.
...
**Fatigue.** The creature gains 1 [Exhaustion](../rules/conditions.md#ExhaustionCondition) level.
...
***Fighting the Contagion.*** Daily at dawn, an infected creature makes a DC 11 Constitution saving throw. On a failed save, the creature gains 1 [Exhaustion](../rules/conditions.md#ExhaustionCondition) level as its fatigue worsens. On a successful save, the creature’s Exhaustion level decreases by 1. If the creature’s Exhaustion level is reduced to 0, the contagion ends on the creature.

---

*Magical Contagion*

Any Beast or Humanoid that drinks water tainted by Sight Rot must succeed on a DC 15 Constitution saving throw or have the [Blinded](../rules/conditions.md#BlindedCondition) condition until the contagion ends.
