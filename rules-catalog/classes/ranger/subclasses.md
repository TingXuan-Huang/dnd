...
You gain one of the following feature options of your choice. Whenever you finish a [Short](../../rules/damage-healing-rests.md#ShortRest) or [Long Rest](../../rules/damage-healing-rests.md#LongRest), you can replace the chosen option with the other one.
...
***Escape the Horde.*** [Opportunity Attacks](../../rules/combat.md#OpportunityAttacks) have [Disadvantage](../../rules/d20-tests.md#Disadvantage) against you.

***Multiattack Defense.*** When a creature hits you with an attack roll, that creature has [Disadvantage](../../rules/d20-tests.md#Disadvantage) on all other attack rolls against you this turn.
